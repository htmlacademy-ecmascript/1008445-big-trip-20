...
const createDistinationTempate = (destinationName, destinations) =>
  /*html*/`<input class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination" value="${ destinationName }" list="destination-list-1">
